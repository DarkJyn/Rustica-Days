...
/**
 * Cây dền - chỉ trồng, tưới và thu hoạch
 */
public class Radish extends Plant {
    ...
    protected void initTextures() {
        try {
            Texture sheet = new Texture(Gdx.files.internal("[Rustica] Asset/Cute_Fantasy/Cute_Fantasy/Crops/Radish.png"));
            int sheetFrames = 7;
            ...
            System.err.println("Could not load Radish texture: " + e.getMessage());
    ...
    private void createDefaultTexture() {
        ...
        for (GrowthState state : GrowthState.values()) {
            ...
            frames[0] = new TextureRegion(new Texture(Gdx.files.internal("[Rustica] Asset/Cute_Fantasy/Cute_Fantasy/Crops/RadishSeed.png")));
