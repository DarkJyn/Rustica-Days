...
/**
 * Cây lúa - chỉ trồng, tưới và thu hoạch
 */
public class Rice extends Plant {
    ...
    public Rice(float x, float y, float width, float height) {
    ...
    protected void initTextures() {
        try {
            Texture riceSheet = new Texture(Gdx.files.internal("assets/[Rustica] Asset/Cute_Fantasy/Cute_Fantasy/Crops/Rice.png"));
    ...
    protected Harvest createHarvestedCrop() {
        return new com.mygdx.game.items.crops.Rice(
            "Lúa",
            FIXED_PRICE,
            FIXED_YIELD
        );
